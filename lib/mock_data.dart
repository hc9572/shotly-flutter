...
List<ScreenshotItem> mockScreenshots() {
  ...
  return List.generate(42, (index) {
    ...
    final date = now.subtract(
      Duration(days: index % 12, hours: index % 5, minutes: index * 7),
    );
    return ScreenshotItem(
      id: 'mock-$index',
      displayName:
          'Screenshot_${date.year}${date.month.toString().padLeft(2, '0')}${date.day.toString().padLeft(2, '0')}_${app}_$index.png',
